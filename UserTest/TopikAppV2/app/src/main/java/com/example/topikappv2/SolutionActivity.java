...
public class    SolutionActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request request = new Request.Builder().url("http://210.114.1.17/topik1_solution/").post(formbody).build();
        ...
        okHttpClient.newCall(request).enqueue(new Callback(){
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                getData("http://210.114.1.17/topik1_solution/"); // visual code 상에서 구현
        ...
        try{
            ...
            for(int i = 0; i < problemList.length(); i++){
                ...
                prob_data.add(new ProblemSet(prob_id,arranged_num,prob_num, question,plural_question ,question_example, text, choice1,
                        choice2, choice3, choice4,answer, score, u_answer,solution,b,b2,b3,b4,prob_set,image,mp3,topik_level, section,example));
                //Log.d("porb id",prob_id);
                //Log.d("arranged_num",arranged_num);
                //Log.d("prob_num",prob_num);
                //Log.d("question",question);
                //Log.d("plural_question",plural_question);
                //Log.d("question_example",question_example);
                //Log.d("text",text);
                //Log.d("choice1",choice1);
                //Log.d("choice2",choice2);
                //Log.d("choice3",choice3);
                //Log.d("choice4",choice4);
                //Log.d("answer",answer);
                //Log.d("score",score);
                //Log.d("u_answer",u_answer);
                //Log.d("solution",solution);
                //Log.d("b",String.valueOf(b));
                //Log.d("b2",String.valueOf(b2));
                //Log.d("b3",String.valueOf(b3));
                //Log.d("b4",String.valueOf(b4));
                //Log.d("prob_set",prob_set);
                //Log.d("image",image);
                //Log.d("mp3",mp3);
                //Log.d("topik_level",topik_level);
