...
public class UserAdapter extends BaseAdapter{
    ...
    private ArrayList<com.example.topikappv2.UserSet> mUserSet = new ArrayList<com.example.topikappv2.UserSet>();
    ...
    // 아이템을 추가
    public void addItem(com.example.topikappv2.UserSet userSet){
        mUserSet.add(userSet);
    }

    public List<com.example.topikappv2.UserSet> returnList() {
        return mUserSet;}

    public void setList(ArrayList<com.example.topikappv2.UserSet> mList) {
        mUserSet = mList;
    }
    ...
    @Override
    public com.example.topikappv2.UserSet getItem(int position) {
...
//                getP_answer(position).toString());
        return new com.example.topikappv2.UserSet(getArranged_num(position).toString(),getNumber(position).toString(),getU_answer(position).toString(),
