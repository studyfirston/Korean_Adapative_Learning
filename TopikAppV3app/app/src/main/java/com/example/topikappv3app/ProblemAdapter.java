...
public class ProblemAdapter extends BaseAdapter{
    private final List<com.example.topikappv2.ProblemSet> mData;
    ...
    public ProblemAdapter(List<com.example.topikappv2.ProblemSet> mData) {
        this.mData = mData;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) { //아이템 한 칸에 들어갈 레이아웃
        ...
        com.example.topikappv2.ProblemSet problemSet = mData.get(position);
//        Log.d("지문",problemSet.getText());
        ...
        if (user_answer != null){
            //O, X그리기
            com.example.topikappv2.O_drawing O_drawing = new com.example.topikappv2.O_drawing(convertView.getContext());
