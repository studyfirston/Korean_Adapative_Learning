...
public class SolveCatActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //리스트 만들면 될 듯.
        getData("http://18.191.167.137/topik1_exam_cat/");
        ...
        String url = "http://18.191.167.137/";
        ...
        if (choice_cat_num.equals("2개")){
            ...
            formbody = new FormBody.Builder().add("selected_problem_cat",selected_prob_cat).add("selected_cat",selected_cat).add("selected_cat2",selected_cat2).add("selected_cat3",selected_cat3).build();
        ...
        Request request = new Request.Builder().url("http://18.191.167.137/topik1_exam_cat/").post(formbody).build();
...
//                        choice2, choice3, choice4));
                    ...
                    prob_data.add(new com.example.topikappv2.ProblemSet(String.valueOf(i + 1), prob_num, question, plural_question, question_example, text, choice1,
