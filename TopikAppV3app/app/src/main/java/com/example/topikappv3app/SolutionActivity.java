...
//                        choice2, choice3, choice4,answer, score, u_answer,solution,b,b2,b3,b4));
                ...
                prob_data.add(new com.example.topikappv2.ProblemSet(arranged_num,prob_num, question,plural_question ,question_example, text, choice1,
                        choice2, choice3, choice4,answer, score, u_answer,solution,b,b2,b3,b4,prob_set,image,mp3));
            }
            com.example.topikappv2.ProblemAdapter adapter = new com.example.topikappv2.ProblemAdapter(prob_data);
