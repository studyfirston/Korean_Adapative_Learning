...
public class UserSet implements Serializable,Comparable<UserSet>{
    ...
    public UserSet(String problem_id, String arranged_num, String number, String user_answer, String real_answer, String prob_set, String score, int time_stamp, int change,String section) {
        this.problem_id = problem_id;
        this.arranged_num =arranged_num;
        this.prob_num = number;
        this.u_answer = user_answer;
        this.r_answer = real_answer;
        if(Integer.parseInt(this.u_answer) == Integer.parseInt(this.r_answer)){
            this.final_result = "O";
        } else {
            this.final_result = "X";
        }
