...
//                getP_answer(position).toString());
        return new UserSet(getArranged_num(position),getNumber(position),getU_answer(position),
                getP_answer(position),getProb_set(position),getScore(position));
    }

    public String getProb_set(int position) { return mUserSet.get(position).getProb_set();}
    public String getArranged_num(int position) {
        return mUserSet.get(position).getArranged_num();
    }
    public String getU_answer(int position){
        return mUserSet.get(position).getU_answer();
    }
    public String getP_answer(int position){
    ...
    public String getScore(int position) {return mUserSet.get(position).getScore();}
