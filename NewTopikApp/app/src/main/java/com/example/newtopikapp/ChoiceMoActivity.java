...
public class ChoiceMoActivity extends AppCompatActivity{
    ...
    public void go_solve_mo(View view) {
        ...
        intent.putExtra(CHOICE_PROB,choice_prob_int);
