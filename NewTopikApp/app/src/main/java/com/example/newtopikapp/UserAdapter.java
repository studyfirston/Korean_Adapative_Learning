...
public class UserAdapter extends BaseAdapter{
    ...
    public void deleteItem(int problem_number) {
        ...
        while (i <= mUserSet.size()){
            if(mUserSet.get(mUserSet.size()-i).getNumber().toString() == String.valueOf(problem_number)){
    ...
    public UserSet getItem(int position) {
        return new UserSet(getU_answer(position).toString(),
                getP_answer(position).toString(),getNumber(position).toString(),getPoint(position).toString());
    }
    ...
    public Object getNumber(int position) {
        return mUserSet.get(position).getNumber();
    }

    public Object getResult(int position) {
        return mUserSet.get(position).getFinal_result();
    }
    public Object getPoint(int position) {return mUserSet.get(position).getPoint();}
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        resultView.setResultNumber(mUserSet.get(position).getNumber());
        ...
        resultView.setPoint(mUserSet.get(position).getPoint());
