...
public class SolveMoActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selected_level = intent.getStringExtra(CHOICE_LEVEL);
        ...
        RequestBody formbody = new FormBody.Builder().add("selected_level",selected_level).add("selected_problem",selected_problem).add("selected_round",selected_round).build();

        Request request = new Request.Builder().url("http://13.209.64.234/topik1_exam_mo/").post(formbody).build();
        ...
        okHttpClient.newCall(request).enqueue(new Callback(){
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                getData("http://13.209.64.234/topik1_exam_mo/");
...
//                        choice2, choice3, choice4,answer, score, null,solution));
                    ...
                    prob_data.add(new ProblemSet(prob_id,String.valueOf(i + 1), prob_num, question, plural_question, question_example, text, choice1,
                            choice2, choice3, choice4, answer, score, null, solution, checked1, checked2, checked3, checked4, prob_set, image,mp3,topik_level,section));
                }
